...
| ~~the **crossover measurement**~~ | PLAN §4.5.1 | **MEASURED 2026-08-28 and struck from this file.** ~2,650 lines before 24 fresh threads beat one; **~170** before 24 from a warm pool do. It could not be taken before M2, because the walk it measures did not exist. The answer is in PLAN §4.5.1 beside the decision it justifies |
