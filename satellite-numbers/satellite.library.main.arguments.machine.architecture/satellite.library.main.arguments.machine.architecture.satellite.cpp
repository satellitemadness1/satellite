// satellite.library.main.arguments.machine.architecture  `1 14 1 1 1 4` -- the architecture this machine is.
//
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.machine.architecture";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
    ...
    row->numbers[5] = 4;
    row->depth = 6;
    row->scenarios.fact = &satellite004::machine_facts::answer_architecture;
