// satellite-004/satellite-numbers/satellite.variable.string.contains(x)/satellite.variable.string.contains(x).satellite.cpp
//
...
// which the interpreter calls once at start-up. Built as 1.6.1.4.so by
