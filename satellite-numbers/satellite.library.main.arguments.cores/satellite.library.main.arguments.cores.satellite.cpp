// satellite.library.main.arguments.cores  `1 14 1 1 13` -- how many cores this machine has.
//
// AN ALIAS OF `arguments.machine.cores`, on the author's word (2026-09-18):
...
// machine_facts.hpp's answer_cores(), so the two cannot answer differently,
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.cores";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
