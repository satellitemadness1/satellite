// satellite.library.main.arguments.system.kernel  `1 14 1 1 4 2` -- the kernel's name.
//
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.system.kernel";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
    ...
    row->numbers[5] = 2;
    row->depth = 6;
    row->scenarios.fact = &satellite004::machine_facts::answer_kernel;
