// satellite-004/satellite-numbers/satellite.directory.list(d)/satellite.directory.list(d).satellite.cpp
//
...
// which the interpreter calls once at start-up. Built as 1.18.5.so by
