// satellite.library.main.arguments.session.shell  `1 14 1 1 8 1` -- the shell this session was started from.
//
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.session.shell";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
    ...
    row->numbers[5] = 1;
    row->depth = 6;
    row->scenarios.fact = &satellite004::machine_facts::answer_shell;
