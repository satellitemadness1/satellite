// satellite.library.main.arguments.machine.pointer_bits  `1 14 1 1 1 7` -- how wide a pointer is in this build.
//
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.machine.pointer_bits";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
    ...
    row->numbers[5] = 7;
    row->depth = 6;
    row->scenarios.fact = &satellite004::machine_facts::answer_pointer_bits;
