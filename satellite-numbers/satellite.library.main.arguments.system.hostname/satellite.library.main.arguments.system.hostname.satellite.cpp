// satellite.library.main.arguments.system.hostname  `1 14 1 1 4 7` -- this machine's host name.
//
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.system.hostname";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
    ...
    row->numbers[5] = 7;
    row->depth = 6;
    row->scenarios.fact = &satellite004::machine_facts::answer_hostname;
