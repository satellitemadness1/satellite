// satellite-004/satellite-numbers/satellite.variable.string.at(n)/satellite.variable.string.at(n).satellite.cpp
//
...
// which the interpreter calls once at start-up. Built as 1.6.1.16.so by
