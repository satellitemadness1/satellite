// satellite-004/satellite-numbers/satellite.variable.string.number/satellite.variable.string.number.satellite.cpp
//
...
// which the interpreter calls once at start-up. Built as 1.6.1.20.so by
