// satellite-004/satellite-numbers/satellite.variable.string.binary/satellite.variable.string.binary.satellite.cpp
//
// satellite.variable.string.binary   1 6 1 21
// The text as bits. Waits for 004's binary type.
//
// A library with no main: it exports satellite_number_describe (number_row.hpp),
// which the interpreter calls once at start-up. Built as 1.6.1.21.so by
...
{
    row->name = "satellite.variable.string.binary";
    row->numbers[0] = 1;
    row->numbers[1] = 6;
    row->numbers[2] = 1;
    row->numbers[3] = 21;
