// satellite.library.main.arguments.machine.byte_order  `1 14 1 1 1 5` -- which way round this machine stores a number.
//
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.machine.byte_order";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
    ...
    row->numbers[5] = 5;
    row->depth = 6;
    row->scenarios.fact = &satellite004::machine_facts::answer_byte_order;
