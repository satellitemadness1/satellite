// satellite.library.main.arguments.machine.page_size  `1 14 1 1 1 6` -- one page of memory, in bytes.
//
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.machine.page_size";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
    ...
    row->numbers[5] = 6;
    row->depth = 6;
    row->scenarios.fact = &satellite004::machine_facts::answer_page_size;
