// satellite.library.main.arguments.system.distribution_id  `1 14 1 1 4 5` -- the distribution's short id.
//
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.system.distribution_id";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
    ...
    row->numbers[5] = 5;
    row->depth = 6;
    row->scenarios.fact = &satellite004::machine_facts::answer_distribution_id;
