// satellite.library.main.arguments.process.id  `1 14 1 1 7 1` -- this interpreter's process id.
//
...
extern "C" signed long long int satellite_number_describe(satellite004::LibraryRow *row)
{
    ...
    row->name = "satellite.library.main.arguments.process.id";
    row->numbers[0] = 1;
    row->numbers[1] = 14;
    row->numbers[2] = 1;
    row->numbers[3] = 1;
    ...
    row->numbers[5] = 1;
    row->depth = 6;
    row->scenarios.fact = &satellite004::machine_facts::answer_process_id;
