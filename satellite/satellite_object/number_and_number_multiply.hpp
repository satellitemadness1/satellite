#pragma once
// satellite/satellite_object/number_and_number_multiply.hpp -- ONE FUNCTION, ONE FILE.
//
...
//
// number * number -> number. One limb times one limb is checked through
// unsigned __int128 and only spreads into more limbs when it must.
//
// CANNOT REFUSE.
//
...
inline signed long long int number_and_number_multiply(const satellite_number &left,
