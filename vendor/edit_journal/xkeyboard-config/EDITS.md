# EDITS -- vendor/xkeyboard-config/

**Project:** xkeyboard-config-2.48
**From:** `vendor/new/xkeyboard-config-2.48.tar.xz` -- unpacked to `vendor/xkeyboard-config/xkeyboard-config-2.48/` on 2026-09-20
