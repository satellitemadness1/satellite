...
Status: **built**, 2026-08-19. `random.hpp`, `random.cpp`, `bignum/random.cpp`, six rows in
...
So the draw happens at the `Number` level, in `bignum/random.cpp`, which knows nothing about
