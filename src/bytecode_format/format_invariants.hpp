...
// The invariants — part of format.hpp, which includes this file. This part
// re-expands the X-macro lists it asserts over, so the static_asserts below
// still see them in whatever translation unit includes this header.
