...
static void activate(GtkApplication *app, gpointer)
{
    ...
    // guess of white-on-light-blue is an invisible prompt on any light console.
    //
    // The environment is copied rather than replaced: g_get_environ() is what
    // the nullptr below meant, plus one entry, so the child still inherits
    // everything else it had -- PATH, HOME, TERM and the rest.
