...
// src/programs/satl-term/ but for its include paths -- 004's satl has no Ctrl-C
// handler yet, so the SIGINT described below stops it outright rather than at a
// statement boundary. The milestones, sections and src/ paths named below are
// 003's.
//
