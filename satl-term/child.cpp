...
// src/programs/satl-term/ but for its include paths -- it runs the satl beside it
// with --repl or --run <file> [words...], which 004's satl understands. The
// milestones, sections and src/ paths named below are 003's.
//
