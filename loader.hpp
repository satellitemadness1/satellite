...
// one; the loader finds it, parses it, and merges its declarations into the
// includer's — and only then does resolve() run, over the merged whole.
//
...
//
//   - finding a spaceship by name (the search order below)
