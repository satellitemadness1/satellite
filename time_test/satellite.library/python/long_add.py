# time_test/satellite.library/python/long_add.py -- the Python equivalent of
# programs/long_add.satl: t = t + third, a float of 128 places, 200,000 turns.
# A satellite float is a decimal.Decimal: the division is rounded to 128 places half away from
# zero, as satl rounds it; adding two 128-place values is exact and needs no rounding.
...
# end; 400 digits of working precision so a sum or product is exact before it is rounded.
getcontext().prec = 400
